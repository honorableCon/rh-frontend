...
export default function Docs() {
  return (
    <div className="py-8 max-w-full bg-white text-gray-700 shadow">
      <h2 className="text-3xl font-medium pl-7 mb-10">Documentation</h2>
      ...
      <section className="mb-16 px-3 md:px-8 pt-8 bg-white">
      ...
      <section className="mb-16 px-3 md:px-8 ">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap md:flex-nowrap pl-6 mt-4">
            ...
            <p className="pl-1">
              As each<span className="px-1 font-medium">sidenav-section</span>{' '}
              has an icon, this sub-folder contains the icons of each
              sidenav-section. You don't need this folder if you are using a
              package for icons such as
          ...
          <div className="flex flex-wrap md:flex-nowrap pl-6 mt-6">
            <JsIcon /> <span className="px-2 font-medium">accordion.js</span> :
            <p className="pl-1">
              contains the<span className="px-1 font-medium">Accordion</span>
      ...
      <section className="mb-16 px-3 md:px-8">
        ...
        <p className="mt-5">
          ...
          as prop
          <span className="px-1 font-medium">mobilePosition</span>, which
