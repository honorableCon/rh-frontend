  ...
  return (
    <div
      ...
      className={
        close
          ? 'hidden'
          : 'absolute flex justify-between items-center w-full max-w-xs p-4 space-x-4 text-gray-500 bg-white rounded-lg shadow bottom-5 right-5 dark:text-gray-400 space-x dark:bg-gray-800'
      }
      role="alert"
    >
