  ...
  return (
    <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
      <div className="flex justify-end px-4 pt-4">
        ...
        >
          <ul className="py-1" aria-labelledby="dropdownButton">
            ...
            <li>
              <a href="#" className="block py-2 px-4 text-sm text-red-600">
                Delete
              </a>
            </li>
          </ul>
      ...
      <div className="flex flex-col items-center pb-10">
        ...
        <span className="text-sm text-gray-500">{personnel.email}</span>
        <div className="flex mt-4 space-x-3 lg:mt-6">
          <Link
            href={`/personnels/details?id=${personnel.id}`}
            as={`/personnels/details`}
            passHref
          >
            <a
              href="#"
              className="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-secondary-900 rounded-lg hover:bg-secondary-700 focus:ring-4 focus:outline-none focus:ring-blue-300"
            >
              Details
            </a>
          </Link>
