      ...
      <Link href={`/personnel/[id]`} as={`/personnel/${personnel.id}`} passHref>
        ...
        <div className="flex flex-col items-center pb-10">
            ...
            <div className="flex mt-4 space-x-3 lg:mt-6">
                <a href="#" className="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-secondary-900 rounded-lg hover:bg-secondary-700 focus:ring-4 focus:outline-none focus:ring-blue-300">Add friend</a>
