...
<div class="md:p-8 p-6 bg-white shadow-xl rounded-xl flex justify-between dark:bg-gray-800 md:items-center md:flex-row flex-col gap-12">
    <div>
...
export default EffectifHeadCard